...
void write_sp_info(FILE *fp, char class) 
{
  ...
  else if (class == 'B') { problem_size = 102; dt = "0.001";   niter = 1000; } // (jana) mudei - era 400
  else if (class == 'C') { problem_size = 162; dt = "0.00067"; niter = 1000; } // (jana) mudei - era 400
...
void write_bt_info(FILE *fp, char class) 
{
  ...
  else if (class == 'B') { problem_size = 102; dt = "0.0003";  niter = 1000; } // (jana) mudei era 200
  else if (class == 'C') { problem_size = 162; dt = "0.0001";  niter = 1000; } // (jana) mudei era 200
...
void write_lu_info(FILE *fp, char class) 
{
  ...
  else if (class == 'B') { problem_size = 102; dt_default = "2.0"; itmax = 1000; } // (jana) mudei era: 250
  else if (class == 'C') { problem_size = 162; dt_default = "2.0"; itmax = 1000; } // (jana) mudei era: 250
...
/*  else if (class == 'W') { problem_size = 64; nit = 40; }*/
  ...
  else if (class == 'B') { problem_size = 256; nit = 1000; } // (jana mudei - era 20)
  else if (class == 'C') { problem_size = 512; nit = 1000; } // (jana) mudei era 20
...
void write_cg_info(FILE *fp, char class) 
{
  ...
  { na=75000; nonzer=13; niter=1000; shift=shiftB; } // (jana) mudei era 75
  else if( class == 'C' )
  { na=150000; nonzer=15; niter=1000; shift=shiftC; } // (jana) mudei era 75
  else if( class == 'D' )
...
void write_ua_info(FILE *fp, char class) 
{
  ...
  { lelt=8800;  lmor=334600;   refine_max=7;  niter=1000; nmxh=10; alpha="0.076e0"; } // (jana) mudei era 200
  else if( class == 'C' )
  { lelt=33500; lmor=1262100;  refine_max=8;  niter=1000; nmxh=10; alpha="0.067e0"; } // (jana) mudei era 200
  else if( class == 'D' )
...
void write_ft_info(FILE *fp, char class) 
{
  ...
  else if (class == 'B') { nx = 512; ny = 256; nz = 256; niter =1000;} // (jana) mudei era 20
  else if (class == 'C') { nx = 512; ny = 512; nz = 512; niter =1000;} // (jana) mudei era 20
