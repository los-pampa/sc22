...
void write_sp_info(FILE *fp, char class) 
{
  ...
  else if (class == 'I') { problem_size = 162; dt = "0.00067"; niter = 1000; }
  else {
...
void write_bt_info(FILE *fp, char class) 
{
  ...
  else if (class == 'E') { problem_size = 1020; dt = "0.4e-5";    niter = 500; }
  else if (class == 'I') { problem_size = 162; dt = "0.0001";    niter = 500; }
  else {
    printf("setparams: Internal error: invalid class %c\n", class);
    exit(1);
  }
...
void write_dc_info(FILE *fp, char class) 
{
  ...
  else if (class == 'I') { input_tuples = 1000000; attrnum = 200; }
  else {
    printf("setparams: Internal error: invalid class %c\n", class);
    exit(1);
  }
...
void write_lu_info(FILE *fp, char class) 
{
  ...
  else if (class == 'I') { problem_size = 162; dt_default = "2.0"; itmax = 600; }
  else {
    printf("setparams: Internal error: invalid class %c\n", class);
    exit(1);
  }
...
/*  else if (class == 'W') { problem_size = 64; nit = 40; }*/
  ...
  else if (class == 'B') { problem_size = 256; nit = 100; }
  else if (class == 'C') { problem_size = 512; nit = 100; }
  //else if (class == 'C') { problem_size = 512; nit = 20; }
  else if (class == 'D') { problem_size = 1024; nit = 50; }
  else if (class == 'E') { problem_size = 2048; nit = 50; }
  else if (class == 'I') { problem_size = 512; nit = 400; }
  else {
...
void write_cg_info(FILE *fp, char class) 
{
  ...
  { na=1500000; nonzer=15; niter=250; shift=shiftC; }
  else
  {
    printf("setparams: Internal error: invalid class type %c\n", class);
    exit(1);
...
void write_ua_info(FILE *fp, char class) 
{
  ...
  { lelt=33500; lmor=1262100; refine_max=8; niter=500; nmxh=20; alpha="0.064e0"; }
  else
  {
    printf("setparams: Internal error: invalid class type %c\n", class);
    exit(1);
...
void write_ft_info(FILE *fp, char class) 
{
  ...
  else if (class == 'I') { nx = 512; ny = 512; nz = 512; niter =100;}
  else {
    printf("setparams: Internal error: invalid class type %c\n", class);
    exit(1);
  }
